...
int main()
{
	...
	while (flag1==1)
	{
		...
		cout << "Выражение в качестве операндов может содержать переменные и вещественные числа(точка разделяет целую и дробную части), в том числе и отрицательные." <<endl;
